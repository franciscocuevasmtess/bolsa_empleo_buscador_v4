...
require_once("include/persons_referencia_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "eportal.persons_referencia" );
