...
class ListPage extends RunnerPage
{
	...
	{
		if( postvalue("pageType") == "register" && postvalue("table") == "bolsa_empleo.bolsa_users" )
			return new ProjectSettings( "bolsa_empleo.bolsa_users", PAGE_REGISTER, "", GLOBAL_PAGES);
	...
	protected static function checkLookupPermissions( $table )
	{
		...
		if( $mainTable == "bolsa_empleo.bolsa_users" )
		{
