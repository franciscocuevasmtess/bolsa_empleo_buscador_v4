...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("eportal.persons" == $this->chrt_array['tables'][0])
			return true;
		if("eportal.persons_docs" == $this->chrt_array['tables'][0])
			return true;
		if("eportal.country" == $this->chrt_array['tables'][0])
			return true;
		if("eportal.persons_estado_civil_type" == $this->chrt_array['tables'][0])
			return true;
		if("eportal.persons_indigenas_types" == $this->chrt_array['tables'][0])
			return true;
		if("eportal.persons_discap_types" == $this->chrt_array['tables'][0])
			return true;
		if("eportal.persons_referencia" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.cvc_idiomas" == $this->chrt_array['tables'][0])
			return true;
		if("eportal.persons_data_types" == $this->chrt_array['tables'][0])
			return true;
		if("eportal.persons_referencia_tipo" == $this->chrt_array['tables'][0])
			return true;
		...
		if("bolsa_empleo.nivel_programa" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.cvc_instituciones_educativas" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.cvc_niveles_academicos" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.ocupacion_puesto_clasificaciones" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.habilidades" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.cvc_programas" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.tipo_registro_conducir" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.tipo_movilidad" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.vista_movilidad_persona" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.cvc_experiencia_laboral" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.cvc_categoria_experiencia" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.vista_curriculum_cvc" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.cvc_experiencia_laboral" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.cvc_estudios_realizados" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.cvc_programas" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.cvc_idiomas" == $this->chrt_array['tables'][0])
		...
		if("bolsa_empleo.cvc_movilidad" == $this->chrt_array['tables'][0])
			return true;
		if("eportal.persons_phones" == $this->chrt_array['tables'][0])
			return true;
		if("eportal.persons_referencia" == $this->chrt_array['tables'][0])
			return true;
		...
		if("bolsa_empleo.vacancia" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.vacancia_requisito_excluyente_detalle" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.vacancia_requisitos_excluyentes" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.vacancia_habilidad_conocimiento" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.empresas_bolsa" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.postulacion" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.vista_estudios_realizados_union_mec" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.tipo_contrato" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.vacancia_salario_descripcion" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.cvc_niveles_academicos" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.mejorar_empleabilidad" == $this->chrt_array['tables'][0])
			return true;
		...
		if("bolsa_empleo.bolsa_users" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.ficha_social" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.condicion_vivienda" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.personas_aportantes_hogar" == $this->chrt_array['tables'][0])
			return true;
