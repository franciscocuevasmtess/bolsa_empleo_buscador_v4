	...
	*/
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("bolsa_empleo.bolsa_users", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	$projectEntities[ "eportal.persons_docs" ] = array( "url" => "persons_docs", "type" => 0 );
	$projectEntitiesReverse[ "persons_docs" ] = "eportal.persons_docs";
	$projectEntities[ "eportal.country" ] = array( "url" => "country", "type" => 0 );
	$projectEntitiesReverse[ "country" ] = "eportal.country";
	$projectEntities[ "eportal.persons_estado_civil_type" ] = array( "url" => "persons_estado_civil_type", "type" => 0 );
	$projectEntitiesReverse[ "persons_estado_civil_type" ] = "eportal.persons_estado_civil_type";
	$projectEntities[ "eportal.persons_indigenas_types" ] = array( "url" => "persons_indigenas_types", "type" => 0 );
	$projectEntitiesReverse[ "persons_indigenas_types" ] = "eportal.persons_indigenas_types";
	$projectEntities[ "eportal.persons_discap_types" ] = array( "url" => "persons_discap_types1", "type" => 0 );
	$projectEntitiesReverse[ "persons_discap_types1" ] = "eportal.persons_discap_types";
	$projectEntities[ "eportal.persons_referencia" ] = array( "url" => "persons_referencia", "type" => 0 );
	$projectEntitiesReverse[ "persons_referencia" ] = "eportal.persons_referencia";
	$projectEntities[ "bolsa_empleo.cvc_idiomas" ] = array( "url" => "cvc_idiomas", "type" => 0 );
	$projectEntitiesReverse[ "cvc_idiomas" ] = "bolsa_empleo.cvc_idiomas";
	$projectEntities[ "eportal.persons_data_types" ] = array( "url" => "persons_data_types", "type" => 0 );
	$projectEntitiesReverse[ "persons_data_types" ] = "eportal.persons_data_types";
	$projectEntities[ "eportal.persons_referencia_tipo" ] = array( "url" => "persons_referencia_tipo", "type" => 0 );
	$projectEntitiesReverse[ "persons_referencia_tipo" ] = "eportal.persons_referencia_tipo";
	...
	$projectEntities[ "bolsa_empleo.cvc_instituciones_educativas" ] = array( "url" => "cvc_instituciones_educativas", "type" => 0 );
	$projectEntitiesReverse[ "cvc_instituciones_educativas" ] = "bolsa_empleo.cvc_instituciones_educativas";
	...
	$projectEntities[ "bolsa_empleo.ocupacion_puesto_clasificaciones" ] = array( "url" => "ocupacion_puesto_clasificaciones", "type" => 0 );
	$projectEntitiesReverse[ "ocupacion_puesto_clasificaciones" ] = "bolsa_empleo.ocupacion_puesto_clasificaciones";
	$projectEntities[ "bolsa_empleo.habilidades" ] = array( "url" => "habilidades", "type" => 0 );
	$projectEntitiesReverse[ "habilidades" ] = "bolsa_empleo.habilidades";
	$projectEntities[ "bolsa_empleo.cvc_programas" ] = array( "url" => "cvc_programas", "type" => 0 );
	$projectEntitiesReverse[ "cvc_programas" ] = "bolsa_empleo.cvc_programas";
	...
	$projectEntities[ "bolsa_empleo.vista_movilidad_persona" ] = array( "url" => "vista_movilidad_persona", "type" => 0 );
	$projectEntitiesReverse[ "vista_movilidad_persona" ] = "bolsa_empleo.vista_movilidad_persona";
	$projectEntities[ "bolsa_empleo.cvc_experiencia_laboral" ] = array( "url" => "cvc_experiencia_laboral", "type" => 0 );
	$projectEntitiesReverse[ "cvc_experiencia_laboral" ] = "bolsa_empleo.cvc_experiencia_laboral";
	$projectEntities[ "bolsa_empleo.cvc_categoria_experiencia" ] = array( "url" => "cvc_categoria_experiencia", "type" => 0 );
	$projectEntitiesReverse[ "cvc_categoria_experiencia" ] = "bolsa_empleo.cvc_categoria_experiencia";
	$projectEntities[ "bolsa_empleo.vista_curriculum_cvc" ] = array( "url" => "vista_curriculum_cvc", "type" => 0 );
	$projectEntitiesReverse[ "vista_curriculum_cvc" ] = "bolsa_empleo.vista_curriculum_cvc";
	$projectEntities[ "vista_para_curri_experiencia_laboral" ] = array( "url" => "vista_para_curri_experiencia_laboral", "type" => 1 );
	$projectEntitiesReverse[ "vista_para_curri_experiencia_laboral" ] = "vista_para_curri_experiencia_laboral";
	$projectEntities[ "vista_curri_estudios_realizados" ] = array( "url" => "vista_curri_estudios_realizados", "type" => 1 );
	$projectEntitiesReverse[ "vista_curri_estudios_realizados" ] = "vista_curri_estudios_realizados";
	$projectEntities[ "vista_curri_programas_realizados" ] = array( "url" => "vista_curri_programas_realizados", "type" => 1 );
	$projectEntitiesReverse[ "vista_curri_programas_realizados" ] = "vista_curri_programas_realizados";
	$projectEntities[ "vista_curri_idiomas" ] = array( "url" => "vista_curri_idiomas", "type" => 1 );
	$projectEntitiesReverse[ "vista_curri_idiomas" ] = "vista_curri_idiomas";
	$projectEntities[ "vista_curri_movilidad" ] = array( "url" => "vista_curri_movilidad", "type" => 1 );
	$projectEntitiesReverse[ "vista_curri_movilidad" ] = "vista_curri_movilidad";
	$projectEntities[ "vista_curri_telefonos" ] = array( "url" => "vista_curri_telefonos", "type" => 1 );
	$projectEntitiesReverse[ "vista_curri_telefonos" ] = "vista_curri_telefonos";
	$projectEntities[ "vista_curri_referencia_laborales" ] = array( "url" => "vista_curri_referencia_laborales", "type" => 1 );
	$projectEntitiesReverse[ "vista_curri_referencia_laborales" ] = "vista_curri_referencia_laborales";
	...
	$projectEntities[ "detalle_vacancia" ] = array( "url" => "detalle_vacancia", "type" => 1 );
	$projectEntitiesReverse[ "detalle_vacancia" ] = "detalle_vacancia";
	$projectEntities[ "bolsa_empleo.vacancia_requisito_excluyente_detalle" ] = array( "url" => "vacancia_requisito_excluyente_detalle", "type" => 0 );
	$projectEntitiesReverse[ "vacancia_requisito_excluyente_detalle" ] = "bolsa_empleo.vacancia_requisito_excluyente_detalle";
	$projectEntities[ "bolsa_empleo.vacancia_requisitos_excluyentes" ] = array( "url" => "vacancia_requisitos_excluyentes", "type" => 0 );
	$projectEntitiesReverse[ "vacancia_requisitos_excluyentes" ] = "bolsa_empleo.vacancia_requisitos_excluyentes";
	$projectEntities[ "bolsa_empleo.vacancia_habilidad_conocimiento" ] = array( "url" => "vacancia_habilidad_conocimiento", "type" => 0 );
	$projectEntitiesReverse[ "vacancia_habilidad_conocimiento" ] = "bolsa_empleo.vacancia_habilidad_conocimiento";
	...
	$projectEntities[ "bolsa_empleo.vista_estudios_realizados_union_mec" ] = array( "url" => "vista_estudios_realizados_union_mec", "type" => 1 );
	$projectEntitiesReverse[ "vista_estudios_realizados_union_mec" ] = "bolsa_empleo.vista_estudios_realizados_union_mec";
	...
	$projectEntities[ "bolsa_empleo.vacancia_salario_descripcion" ] = array( "url" => "vacancia_salario_descripcion", "type" => 0 );
	$projectEntitiesReverse[ "vacancia_salario_descripcion" ] = "bolsa_empleo.vacancia_salario_descripcion";
	$projectEntities[ "bolsa_empleo.cvc_niveles_academicos1" ] = array( "url" => "cvc_niveles_academicos1", "type" => 1 );
	$projectEntitiesReverse[ "cvc_niveles_academicos1" ] = "bolsa_empleo.cvc_niveles_academicos1";
	$projectEntities[ "bolsa_empleo.mejorar_empleabilidad" ] = array( "url" => "mejorar_empleabilidad", "type" => 0 );
	$projectEntitiesReverse[ "mejorar_empleabilidad" ] = "bolsa_empleo.mejorar_empleabilidad";
	...
	$projectEntities[ "bolsa_empleo.ficha_social" ] = array( "url" => "ficha_social", "type" => 0 );
	$projectEntitiesReverse[ "ficha_social" ] = "bolsa_empleo.ficha_social";
	$projectEntities[ "bolsa_empleo.condicion_vivienda" ] = array( "url" => "condicion_vivienda", "type" => 0 );
	$projectEntitiesReverse[ "condicion_vivienda" ] = "bolsa_empleo.condicion_vivienda";
	$projectEntities[ "bolsa_empleo.personas_aportantes_hogar" ] = array( "url" => "personas_aportantes_hogar", "type" => 0 );
