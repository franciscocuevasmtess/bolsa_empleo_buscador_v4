...
require_once("include/vacancia_requisito_excluyente_detalle_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "bolsa_empleo.vacancia_requisito_excluyente_detalle" );
