...
require_once("include/vista_curri_movilidad_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "vista_curri_movilidad" );
