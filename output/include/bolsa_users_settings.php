...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$fieldLabelsbolsa_users["Spanish"]["cantidad_omision_cambio_password"] = "Cantidad Omision Cambio Password";
	$fieldToolTipsbolsa_users["Spanish"]["cantidad_omision_cambio_password"] = "";
	$placeHoldersbolsa_users["Spanish"]["cantidad_omision_cambio_password"] = "";
...
$tdatabolsa_users[".googleLikeFields"][] = "cantidad_omision_cambio_password";
...
$tdatabolsa_users[".sqlHead"] = "SELECT id,  	nro_documento,  	clave,  	email,  	groupid,  	active,  	reset_token,  	reset_date,  	fecha_alta,  	llave,  	estado_llave,  	senadis,  	trabajo_antes,  	userpic,  	personaid,  	fullname,  	username,  	hash_generado,  	adjunto_foto_perfil,  	cantidad_omision_cambio_password";
...
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 20;
	$fdata["strName"] = "cantidad_omision_cambio_password";
	$fdata["GoodName"] = "cantidad_omision_cambio_password";
	$fdata["ownerTable"] = "bolsa_empleo.bolsa_users";
	$fdata["Label"] = GetFieldLabel("bolsa_empleo_bolsa_users","cantidad_omision_cambio_password");
	$fdata["FieldType"] = 3;
		...
		$fdata["strField"] = "cantidad_omision_cambio_password";

		$fdata["sourceSingle"] = "cantidad_omision_cambio_password";

	
		$fdata["isSQLExpression"] = true;
	$fdata["FullName"] = "cantidad_omision_cambio_password";
...
//end of Filters settings
	...
	$tdatabolsa_users["cantidad_omision_cambio_password"] = $fdata;
		$tdatabolsa_users[".searchableFields"][] = "cantidad_omision_cambio_password";
...
$proto0["m_strFieldList"] = "id,  	nro_documento,  	clave,  	email,  	groupid,  	active,  	reset_token,  	reset_date,  	fecha_alta,  	llave,  	estado_llave,  	senadis,  	trabajo_antes,  	userpic,  	personaid,  	fullname,  	username,  	hash_generado,  	adjunto_foto_perfil,  	cantidad_omision_cambio_password";
...
$proto0["m_fieldlist"][]=$obj;
						$proto44=array();
			$obj = new SQLField(array(
	"m_strName" => "cantidad_omision_cambio_password",
	"m_strTable" => "bolsa_empleo.bolsa_users",
	"m_srcTableName" => "bolsa_empleo.bolsa_users"
));

$proto44["m_sql"] = "cantidad_omision_cambio_password";
