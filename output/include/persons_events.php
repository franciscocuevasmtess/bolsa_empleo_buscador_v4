 ...
 */
 ...
 class eventclass_persons  extends eventsBase
{
...
$id_multados_multi = explode(",",$values['multiselect_discapacidades']);
      ...
      foreach ($id_multados_multi as  $valuetoinsert)
      {
				...
				{
				$message="Si seleccionó NINGUNA DISCAPACIDAD, solamente esa debe estar, no seleccione otras mas!!" ;
...
from eportal.persons_phones where type = 2 and person_id = ':1' limit 1",$values["id"]);
