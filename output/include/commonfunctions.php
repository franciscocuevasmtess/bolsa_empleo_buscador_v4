...
function checkTableName($shortTName )
{
	...
	if ("persons" == $shortTName )
		return true;
	if ("persons_docs" == $shortTName )
		return true;
	if ("country" == $shortTName )
		return true;
	if ("persons_estado_civil_type" == $shortTName )
		return true;
	if ("persons_indigenas_types" == $shortTName )
		return true;
	if ("persons_discap_types1" == $shortTName )
		return true;
	if ("persons_referencia" == $shortTName )
		return true;
	if ("cvc_idiomas" == $shortTName )
		return true;
	if ("persons_data_types" == $shortTName )
		return true;
	if ("persons_referencia_tipo" == $shortTName )
		return true;
	...
	if ("nivel_programa" == $shortTName )
		return true;
	if ("cvc_instituciones_educativas" == $shortTName )
		return true;
	if ("cvc_niveles_academicos" == $shortTName )
		return true;
	if ("ocupacion_puesto_clasificaciones" == $shortTName )
		return true;
	if ("habilidades" == $shortTName )
		return true;
	if ("cvc_programas" == $shortTName )
		return true;
	if ("tipo_registro_conducir" == $shortTName )
		return true;
	if ("tipo_movilidad" == $shortTName )
		return true;
	if ("vista_movilidad_persona" == $shortTName )
		return true;
	if ("cvc_experiencia_laboral" == $shortTName )
		return true;
	if ("cvc_categoria_experiencia" == $shortTName )
		return true;
	if ("vista_curriculum_cvc" == $shortTName )
		return true;
	if ("vista_para_curri_experiencia_laboral" == $shortTName )
		return true;
	if ("vista_curri_estudios_realizados" == $shortTName )
		return true;
	if ("vista_curri_programas_realizados" == $shortTName )
		return true;
	if ("vista_curri_idiomas" == $shortTName )
		return true;
	if ("vista_curri_movilidad" == $shortTName )
		return true;
	if ("vista_curri_telefonos" == $shortTName )
		return true;
	if ("vista_curri_referencia_laborales" == $shortTName )
		return true;
	if ("actividad_econ" == $shortTName )
		return true;
	if ("detalle_vacancia" == $shortTName )
		return true;
	if ("vacancia_requisito_excluyente_detalle" == $shortTName )
		return true;
	if ("vacancia_requisitos_excluyentes" == $shortTName )
		return true;
	if ("vacancia_habilidad_conocimiento" == $shortTName )
		return true;
	if ("empresas_bolsa" == $shortTName )
		return true;
	if ("postulacion" == $shortTName )
		return true;
	if ("vista_estudios_realizados_union_mec" == $shortTName )
		return true;
	if ("tipo_contrato" == $shortTName )
		return true;
	if ("vacancia_salario_descripcion" == $shortTName )
		return true;
	if ("cvc_niveles_academicos1" == $shortTName )
		return true;
	if ("mejorar_empleabilidad" == $shortTName )
		return true;
	...
	if ("cvc_movilidad" == $shortTName )
		return true;
	if ("bolsa_users_cambio_contrasenha" == $shortTName )
		return true;
	if ("ficha_social" == $shortTName )
		return true;
	if ("condicion_vivienda" == $shortTName )
		return true;
	if ("personas_aportantes_hogar" == $shortTName )
		return true;
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("eportal.persons_docs");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="eportal.persons_docs";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("eportal.persons_estado_civil_type");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="eportal.persons_estado_civil_type";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("eportal.persons_indigenas_types");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="eportal.persons_indigenas_types";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("eportal.persons_referencia");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="eportal.persons_referencia";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.cvc_idiomas");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.cvc_idiomas";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("eportal.persons_data_types");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="eportal.persons_data_types";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("eportal.persons_referencia_tipo");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="eportal.persons_referencia_tipo";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.cvc_instituciones_educativas");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.cvc_instituciones_educativas";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.ocupacion_puesto_clasificaciones");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.ocupacion_puesto_clasificaciones";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.habilidades");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.habilidades";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.cvc_programas");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.cvc_programas";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.vista_movilidad_persona");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.vista_movilidad_persona";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.cvc_experiencia_laboral");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.cvc_experiencia_laboral";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.cvc_categoria_experiencia");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.cvc_categoria_experiencia";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.vista_curriculum_cvc");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.vista_curriculum_cvc";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("vista_para_curri_experiencia_laboral");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="vista_para_curri_experiencia_laboral";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("vista_curri_estudios_realizados");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="vista_curri_estudios_realizados";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("vista_curri_programas_realizados");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="vista_curri_programas_realizados";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("vista_curri_idiomas");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="vista_curri_idiomas";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("vista_curri_movilidad");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="vista_curri_movilidad";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("vista_curri_telefonos");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="vista_curri_telefonos";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("vista_curri_referencia_laborales");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="vista_curri_referencia_laborales";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("detalle_vacancia");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="detalle_vacancia";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.vacancia_requisito_excluyente_detalle");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.vacancia_requisito_excluyente_detalle";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.vacancia_requisitos_excluyentes");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.vacancia_requisitos_excluyentes";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.vacancia_habilidad_conocimiento");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.vacancia_habilidad_conocimiento";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.vista_estudios_realizados_union_mec");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.vista_estudios_realizados_union_mec";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.vacancia_salario_descripcion");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.vacancia_salario_descripcion";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.cvc_niveles_academicos1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.cvc_niveles_academicos1";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.mejorar_empleabilidad");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.mejorar_empleabilidad";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.bolsa_users_cambio_contrasenha");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.bolsa_users_cambio_contrasenha";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.ficha_social");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.ficha_social";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.condicion_vivienda");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.personas_aportantes_hogar");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.ingreso_mensual_aproximado");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
...
//	default permissions
	...
	if( $table=="eportal.persons_estado_civil_type" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="eportal.persons_indigenas_types" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="eportal.persons_referencia" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="bolsa_empleo.cvc_idiomas" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="eportal.persons_data_types" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="eportal.persons_referencia_tipo" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="bolsa_empleo.cvc_instituciones_educativas" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="bolsa_empleo.ocupacion_puesto_clasificaciones" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="bolsa_empleo.habilidades" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="bolsa_empleo.cvc_programas" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="bolsa_empleo.vista_movilidad_persona" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="bolsa_empleo.cvc_experiencia_laboral" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="bolsa_empleo.cvc_categoria_experiencia" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="bolsa_empleo.vista_curriculum_cvc" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="vista_para_curri_experiencia_laboral" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="vista_curri_estudios_realizados" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="vista_curri_programas_realizados" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="vista_curri_idiomas" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="vista_curri_movilidad" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="vista_curri_telefonos" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="vista_curri_referencia_laborales" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="detalle_vacancia" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="bolsa_empleo.vacancia_requisito_excluyente_detalle" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="bolsa_empleo.vacancia_requisitos_excluyentes" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="bolsa_empleo.vacancia_habilidad_conocimiento" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="bolsa_empleo.vista_estudios_realizados_union_mec" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="bolsa_empleo.vacancia_salario_descripcion" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="bolsa_empleo.cvc_niveles_academicos1" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="bolsa_empleo.mejorar_empleabilidad" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
//	default permissions
	...
	if( $table=="bolsa_empleo.ficha_social" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="bolsa_empleo.condicion_vivienda" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="bolsa_empleo.personas_aportantes_hogar" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
