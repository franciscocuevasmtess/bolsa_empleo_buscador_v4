...
$tdataocupacion_puesto_clasificaciones[".pagesByType"] = my_json_decode( "{\"list\":[\"list\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"search\":[\"search\"]}" );
$tdataocupacion_puesto_clasificaciones[".originalPagesByType"] = $tdataocupacion_puesto_clasificaciones[".pagesByType"];
$tdataocupacion_puesto_clasificaciones[".pages"] = types2pages( my_json_decode( "{\"list\":[\"list\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"search\":[\"search\"]}" ) );
$tdataocupacion_puesto_clasificaciones[".originalPages"] = $tdataocupacion_puesto_clasificaciones[".pages"];
$tdataocupacion_puesto_clasificaciones[".defaultPages"] = my_json_decode( "{\"list\":\"list\",\"masterlist\":\"masterlist\",\"masterprint\":\"masterprint\",\"search\":\"search\"}" );
