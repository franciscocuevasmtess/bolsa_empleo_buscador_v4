...
ell.innerHTML='<div><style>#close {float:left;display:inline-block;padding:2px 5px;background:#ccc;}</style><p>'+'¿Estás seguro que desea Cancelar su Postulación de la siguiente Oferta de Empleo?'+'</p>'+
				 "<table border='0'>"+
					"<tr>	<td rowspan=2 style='padding:10px'> <i class='bi bi-briefcase-fill fa-3x'></i></td>"+
					"<td><b><p>"+row.getFieldValue("nombre_puesto")+"</p></b></td>	</tr>"+
					"<tr>	<td><p>"+row.getFieldValue("legal")+"</p></td>"+
					"</tr>"+
				"</table>"+
				  "</div>";
