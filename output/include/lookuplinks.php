...
function InitLookupLinks()
{
	...
	$lookupTableLinks = array();
		...
		if( !isset( $lookupTableLinks["bolsa_empleo.ocupacion_puesto_clasificaciones"]["cvc_experiencia_laboral.fk_puesto_ocupacion"] )) {
			$lookupTableLinks["bolsa_empleo.ocupacion_puesto_clasificaciones"]["cvc_experiencia_laboral.fk_puesto_ocupacion"] = array();
		}
		$lookupTableLinks["bolsa_empleo.ocupacion_puesto_clasificaciones"]["cvc_experiencia_laboral.fk_puesto_ocupacion"]["search"] = array("table" => "bolsa_empleo.cvc_experiencia_laboral", "field" => "fk_puesto_ocupacion", "page" => "search");
		if( !isset( $lookupTableLinks["eportal.persons_estado_civil_type"] ) ) {
			$lookupTableLinks["eportal.persons_estado_civil_type"] = array();
		}
		...
		if( !isset( $lookupTableLinks["bolsa_empleo.personas_aportantes_hogar"] ) ) {
			$lookupTableLinks["bolsa_empleo.personas_aportantes_hogar"] = array();
		}
		if( !isset( $lookupTableLinks["bolsa_empleo.personas_aportantes_hogar"]["ficha_social.id"] )) {
			$lookupTableLinks["bolsa_empleo.personas_aportantes_hogar"]["ficha_social.id"] = array();
		}
		$lookupTableLinks["bolsa_empleo.personas_aportantes_hogar"]["ficha_social.id"]["edit"] = array("table" => "bolsa_empleo.ficha_social", "field" => "id", "page" => "edit");
		if( !isset( $lookupTableLinks["bolsa_empleo.condicion_vivienda"] ) ) {
			$lookupTableLinks["bolsa_empleo.condicion_vivienda"] = array();
		}
		if( !isset( $lookupTableLinks["bolsa_empleo.condicion_vivienda"]["ficha_social.condicion_vivienda_id"] )) {
			$lookupTableLinks["bolsa_empleo.condicion_vivienda"]["ficha_social.condicion_vivienda_id"] = array();
		}
		$lookupTableLinks["bolsa_empleo.condicion_vivienda"]["ficha_social.condicion_vivienda_id"]["edit"] = array("table" => "bolsa_empleo.ficha_social", "field" => "condicion_vivienda_id", "page" => "edit");
		if( !isset( $lookupTableLinks["bolsa_empleo.personas_aportantes_hogar"] ) ) {
			$lookupTableLinks["bolsa_empleo.personas_aportantes_hogar"] = array();
		}
		if( !isset( $lookupTableLinks["bolsa_empleo.personas_aportantes_hogar"]["ficha_social.persona_aportante_hogar_id"] )) {
			$lookupTableLinks["bolsa_empleo.personas_aportantes_hogar"]["ficha_social.persona_aportante_hogar_id"] = array();
		}
		$lookupTableLinks["bolsa_empleo.personas_aportantes_hogar"]["ficha_social.persona_aportante_hogar_id"]["edit"] = array("table" => "bolsa_empleo.ficha_social", "field" => "persona_aportante_hogar_id", "page" => "edit");
		if( !isset( $lookupTableLinks["bolsa_empleo.ingreso_mensual_aproximado"] ) ) {
			$lookupTableLinks["bolsa_empleo.ingreso_mensual_aproximado"] = array();
		}
		if( !isset( $lookupTableLinks["bolsa_empleo.ingreso_mensual_aproximado"]["ficha_social.ingreso_mensual_aproximado_id"] )) {
			$lookupTableLinks["bolsa_empleo.ingreso_mensual_aproximado"]["ficha_social.ingreso_mensual_aproximado_id"] = array();
		}
		$lookupTableLinks["bolsa_empleo.ingreso_mensual_aproximado"]["ficha_social.ingreso_mensual_aproximado_id"]["edit"] = array("table" => "bolsa_empleo.ficha_social", "field" => "ingreso_mensual_aproximado_id", "page" => "edit");
}
