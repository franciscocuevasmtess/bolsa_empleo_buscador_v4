...
//	bolsa_empleo.ficha_social
		...
		$dIndex = 7;
	$detailsParam = array();
	$detailsParam["dDataSourceTable"]="bolsa_empleo.ficha_social";
		$detailsParam["dOriginalTable"] = "bolsa_empleo.ficha_social";



		
		$detailsParam["dType"]=PAGE_LIST;
	$detailsParam["dShortTable"] = "ficha_social";
	$detailsParam["dCaptionTable"] = GetTableCaption("bolsa_empleo_ficha_social");
	$detailsParam["masterKeys"] =array();
	$detailsParam["detailKeys"] =array();
	...
	$detailsTablesData["eportal.persons"][$dIndex]["detailKeys"][]="id";
//endif
...
$proto85["m_columns"][] = "cod_ine_ciudad";
...
$proto93["m_columns"][] = "codigo_ine_dpto";
...
$proto97["m_columns"][] = "cantidad_omision_cambio_password";
