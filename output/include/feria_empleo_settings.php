...
$tdataferia_empleo[".pagesByType"] = my_json_decode( "{\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdataferia_empleo[".originalPagesByType"] = $tdataferia_empleo[".pagesByType"];
$tdataferia_empleo[".pages"] = types2pages( my_json_decode( "{\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdataferia_empleo[".originalPages"] = $tdataferia_empleo[".pages"];
$tdataferia_empleo[".defaultPages"] = my_json_decode( "{\"search\":\"search\",\"view\":\"view\"}" );
