...
$totalRecordsQuery = "SELECT COUNT(*) AS total FROM bolsa_empleo.cvc_instituciones_educativas $searchCondition";
...
$query = "SELECT cvc_id_instituciones_educativas as id, descripcion as text FROM bolsa_empleo.cvc_instituciones_educativas $searchCondition ORDER BY descripcion LIMIT $records_per_page OFFSET $offset";
